...
public class Model implements BoardGame<Coord> {
	 ...
	 */
	@Override
	public OutputModelData<Coord> moveCapturePromote(Coord toMovePieceCoord, Coord targetSquareCoord, int [] score) {
	...
	private void updateScore(){
		if(PieceSquareColor.WHITE.equals(this.currentGamerColor) )
		{
			this.score[0]++;
		}
		else
		...
		//System.out.println("Score: White "+this.score[0]+" Black "+this.score[1]);
	}
	...
	private boolean is_winner(){
		...
		else if(PieceSquareColor.BLACK.equals(this.currentGamerColor))
		{
			if(score[1] == 20)
			{
				ret = true;
